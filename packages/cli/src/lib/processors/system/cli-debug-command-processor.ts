    ...
    processors?: ICliCommandProcessor[] = [
        ...
        } as ICliCommandProcessor,
        {
            ...
            processCommand: async (_: CliProcessCommand, context: ICliExecutionContext) => {
                ...
                const historyService = context.services.get<CliCommandHistory>(CliCommandHistory_TOKEN);
                writer.writeln(`  ${CliIcon.CheckIcon} History: ${historyService.getHistory().length} commands stored`);
            },
        } as ICliCommandProcessor,
        {
            command: 'export',
