...
describe('CliStringCommandProcessor', () => {
    ...
    describe('sub-processors', () => {
        ...
        it('should include "upper" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'upper');
            expect(sub).toBeDefined();
        });

        it('should include "lower" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'lower');
            expect(sub).toBeDefined();
        });

        it('should include "reverse" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'reverse');
            expect(sub).toBeDefined();
        });

        it('should include "length" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'length');
            expect(sub).toBeDefined();
        });
        ...
        it('should include "capitalize" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'capitalize');
            expect(sub).toBeDefined();
        });

        it('should include "camelCase" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'camelCase');
            expect(sub).toBeDefined();
        });

        it('should include "kebabCase" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'kebabCase');
            expect(sub).toBeDefined();
        });

        it('should include "snakeCase" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'snakeCase');
            expect(sub).toBeDefined();
        });
        ...
        it('should include "includes" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'includes');
            expect(sub).toBeDefined();
        });

        it('should include "startsWith" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'startsWith');
            expect(sub).toBeDefined();
        });

        it('should include "endsWith" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'endsWith');
            expect(sub).toBeDefined();
        });

        it('should include "repeat" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'repeat');
            expect(sub).toBeDefined();
        });

        it('should include "replace" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'replace');
            expect(sub).toBeDefined();
        });

        it('should include "split" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'split');
            expect(sub).toBeDefined();
        });

        it('should include "words" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'words');
            expect(sub).toBeDefined();
        });
        ...
        it('should include "truncate" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'truncate');
            expect(sub).toBeDefined();
        });

        it('should include "escape" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'escape');
            expect(sub).toBeDefined();
        });

        it('should include "unescape" sub-processor', () => {
            const sub = processor.processors!.find(p => p.command === 'unescape');
            expect(sub).toBeDefined();
        });
        ...
        it('should have all sub-processors with valueRequired = true', () => {
            for (const sub of processor.processors!) {
                expect(sub.valueRequired)
                    .withContext(`Sub-processor "${sub.command}" should have valueRequired = true`)
                    .toBe(true);
            }
        });
